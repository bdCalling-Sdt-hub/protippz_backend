...
const createWithdrawRequest = catchAsync(async (req, res) => {
  const result = await WithdrawRequestServices.crateWithdrawRequest(
    req.user,
    req.body,
  );
  sendResponse(res, {
...
const updateWithdrawRequestStatus = catchAsync(async (req, res) => {
  const result = await WithdrawRequestServices.updateWithdrawRequestStatus(
    req.params.id,
    req.body.status,
  );
  sendResponse(res, {
...
const achWithdraw = catchAsync(async (req, res) => {
  const result = await WithdrawRequestServices.achWithdraw(
    req.user,
    req.body.amount,
  );
  sendResponse(res, {
