...
//   useEffect(() => {
//     const eventSource = new EventSource('/api/upload-csv'); // Ensure this endpoint matches your backend route
...
//       }
//       if (data.message) {
//         console.log(data.message); // "Upload complete" message from server
//       }
//     };
